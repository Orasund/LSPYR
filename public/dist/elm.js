...
var $author$project$Gen$Route$Faq = {$: 'Faq'};
var $author$project$Gen$Route$Home_ = {$: 'Home_'};
var $author$project$Gen$Route$Impressum = {$: 'Impressum'};
var $author$project$Gen$Route$Method = {$: 'Method'};
...
var $author$project$Gen$Params$Faq$parser = $elm$url$Url$Parser$s('faq');
...
var $author$project$Gen$Params$Impressum$parser = $elm$url$Url$Parser$s('impressum');
var $author$project$Gen$Params$Method$parser = $elm$url$Url$Parser$s('method');
...
var $author$project$Gen$Route$routes = _List_fromArray(
	[
		...
		A2($elm$url$Url$Parser$map, $author$project$Gen$Route$Faq, $author$project$Gen$Params$Faq$parser),
		A2($elm$url$Url$Parser$map, $author$project$Gen$Route$Impressum, $author$project$Gen$Params$Impressum$parser),
		A2($elm$url$Url$Parser$map, $author$project$Gen$Route$Method, $author$project$Gen$Params$Method$parser),
...
var $author$project$Gen$Model$Faq = F2(
	function (a, b) {
		return {$: 'Faq', a: a, b: b};
	});
var $author$project$Gen$Msg$Faq = function (a) {
	return {$: 'Faq', a: a};
};
...
var $author$project$Gen$Model$Impressum = F2(
	function (a, b) {
		return {$: 'Impressum', a: a, b: b};
	});
var $author$project$Gen$Msg$Impressum = function (a) {
	return {$: 'Impressum', a: a};
};
var $author$project$Gen$Model$Method = F2(
	function (a, b) {
		return {$: 'Method', a: a, b: b};
	});
var $author$project$Gen$Msg$Method = function (a) {
	return {$: 'Method', a: a};
};
...
var $ryannhg$elm_spa$ElmSpa$Page$static = F2(
	function (none, page) {
		return $ryannhg$elm_spa$ElmSpa$Page$Page(
			F2(
				function (_v0, _v1) {
					return $elm$core$Result$Ok(
						A2($ryannhg$elm_spa$ElmSpa$Page$adapters._static, none, page));
				}));
	});
var $author$project$Page$static = $ryannhg$elm_spa$ElmSpa$Page$static($author$project$Effect$none);
var $elm$html$Html$img = _VirtualDom_node('img');
var $author$project$Config$roundedBorder = A2($elm$html$Html$Attributes$style, 'border-radius', '19px');
...
var $author$project$View$DoubleColumn$view = F2(
	function (name, _v0) {
		var c1 = _v0.a;
		var c2 = _v0.b;
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('vstack gap-3')
				]),
			_List_fromArray(
				[
					A2(
...
var $author$project$Config$contentMaxWidth = A2($elm$html$Html$Attributes$style, 'max-width', '802px');
var $author$project$Config$contentWidth = A2($elm$html$Html$Attributes$style, 'width', '88%');
var $author$project$Config$email = '**info@ergotherapie-payr.at**';
var $elm$html$Html$h1 = _VirtualDom_node('h1');
var $elm$html$Html$h6 = _VirtualDom_node('h6');
var $author$project$Config$imageOffset = _List_fromArray(
	[
		A2($elm$html$Html$Attributes$style, 'position', 'relative'),
		A2($elm$html$Html$Attributes$style, 'right', '6.5%'),
		A2($elm$html$Html$Attributes$style, 'top', '-150px')
	]);
var $elm$html$Html$Attributes$attribute = $elm$virtual_dom$VirtualDom$attribute;
var $elm$html$Html$nav = _VirtualDom_node('nav');
var $author$project$View$Page$navbar = F3(
	function (id, route, list) {
		return A2(
			$elm$html$Html$nav,
			_List_fromArray(
				[
			...
			$elm$core$List$singleton(
				A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('container-md')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									...
									A2($elm$html$Html$Attributes$attribute, 'data-bs-target', '#' + id),
									A2($elm$html$Html$Attributes$attribute, 'aria-controls', id),
									A2($elm$html$Html$Attributes$attribute, 'expanded', 'true'),
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('collapse navbar-collapse justify-content-md-center'),
										...
										function (_v0) {
											...
											return A2(
												...
												$elm$core$List$singleton(
													A2(
														$elm$html$Html$a,
														_Utils_eq(route, r) ? _List_fromArray(
															[
															...
															[
																...
																$author$project$Gen$Route$toHref(r))
															]),
														$elm$core$List$singleton(
															$elm$html$Html$text(name)))));
										},
...
var $author$project$Config$telefonNr = '**+43 650 4455988**';
var $author$project$View$Page$view = F2(
	function (route, content) {
		return _List_fromArray(
			[
				A3(
				$author$project$View$Page$navbar,
				'myNavbar',
				route,
				_List_fromArray(
					[
						_Utils_Tuple2('Angebot', $author$project$Gen$Route$Home_),
						_Utils_Tuple2('Methode', $author$project$Gen$Route$Method),
						_Utils_Tuple2('Fragen & Antworten', $author$project$Gen$Route$Faq),
						_Utils_Tuple2('Über Mich', $author$project$Gen$Route$About),
						_Utils_Tuple2('Kontakt', $author$project$Gen$Route$Contact)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_Nil,
								$elm$core$List$singleton(
									$elm$html$Html$text('Lisa Payr'))),
								A2(
								$elm$html$Html$h6,
								_List_Nil,
								$elm$core$List$singleton(
									$elm$html$Html$text('Ergotherapie'))),
								A2(
								$elm$html$Html$h6,
								_List_Nil,
								$elm$core$List$singleton(
									$elm$html$Html$text('Einzelförderung für Schulkinder')))
							]))
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$author$project$Config$contentWidth,
						$author$project$Config$contentMaxWidth,
						A2($elm$html$Html$Attributes$style, 'margin-left', 'auto'),
						A2($elm$html$Html$Attributes$style, 'margin-right', 'auto'),
						$elm$html$Html$Attributes$class('vstack gap-3')
					]),
					...
					[
						...
						_List_fromArray(
							[
								...
								A2($elm$html$Html$Attributes$style, 'width', '113.5%'),
								A2($elm$html$Html$Attributes$style, 'max-width', '910px'),
								A2($elm$html$Html$Attributes$style, 'margin-left', 'auto'),
								A2($elm$html$Html$Attributes$style, 'margin-right', 'auto')
							]),
						$elm$core$List$singleton(
							A2(
								...
								_Utils_ap(
									...
									$author$project$Config$imageOffset),
								_List_Nil))),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
						...
						$elm$core$List$singleton(
							A2(
								...
								$elm$core$List$singleton(content)))),
						A2(
						...
						A2(
							...
							_List_fromArray(
								[
									'Lisa Payr',
									'Telefon: ' + $author$project$Config$telefonNr,
									'Email: ' + $author$project$Config$email,
									'[Impressum](' + ($author$project$Gen$Route$toHref($author$project$Gen$Route$Impressum) + ')')
								])))
					]))
			]);
	});
var $author$project$Pages$About$view = function (route) {
	return {
		body: A2(
			$author$project$View$Page$view,
			route,
			A2(
				$author$project$View$DoubleColumn$view,
				'Über Mich',
				_Utils_Tuple2(
					$elm$core$List$singleton(
						A2(
...
var $author$project$Pages$About$page = F2(
	function (shared, req) {
		return $author$project$Page$static(
			{
				view: $author$project$Pages$About$view(req.route)
			});
	});
...
var $author$project$Pages$Contact$view = function (route) {
	return {
		body: A2(
			$author$project$View$Page$view,
			route,
			A2(
				$author$project$View$SingleColumn$view,
				'Kontakt',
				_List_fromArray(
					[
						A2($elm_explorations$markdown$Markdown$toHtml, _List_Nil, $author$project$Config$address + ('  \nTel.: ' + ($author$project$Config$telefonNr + ('  \nEmail: ' + $author$project$Config$email)))),
						A2(
						$elm$html$Html$a,
						_List_fromArray(
							[
						...
						$elm$core$List$singleton(
							$elm$html$Html$text('Als Kontakt Hinzufügen')))
					]))),
		title: 'Einzelförderung für Schulkinder'
	};
};
var $author$project$Pages$Contact$page = F2(
	function (shared, req) {
		return $author$project$Page$static(
			{
				view: $author$project$Pages$Contact$view(req.route)
			});
	});
var $author$project$Pages$Faq$view = function (route) {
	return {
		body: A2(
			$author$project$View$Page$view,
			route,
...
var $author$project$Pages$Home_$page = F2(
	function (shared, req) {
		return $author$project$Page$static(
			{
				view: $author$project$Pages$Home_$view(req.route)
			});
	});
var $author$project$Pages$Impressum$view = function (route) {
	return {
		body: A2(
			$author$project$View$Page$view,
			route,
...
var $author$project$Pages$Method$page = F2(
	function (shared, req) {
		return $author$project$Page$static(
			{
				view: $author$project$Pages$Method$view(req.route)
			});
	});
...
var $author$project$Gen$Pages$pages = {
	...
	faq: A3($author$project$Gen$Pages$bundle, $author$project$Pages$Faq$page, $author$project$Gen$Model$Faq, $author$project$Gen$Msg$Faq),
	...
	impressum: A3($author$project$Gen$Pages$bundle, $author$project$Pages$Impressum$page, $author$project$Gen$Model$Impressum, $author$project$Gen$Msg$Impressum),
	method: A3($author$project$Gen$Pages$bundle, $author$project$Pages$Method$page, $author$project$Gen$Model$Method, $author$project$Gen$Msg$Method),
...
var $author$project$Gen$Pages$init = function (route) {
	switch (route.$) {
		...
		case 'Faq':
			return $author$project$Gen$Pages$pages.faq.init(_Utils_Tuple0);
		case 'Home_':
			return $author$project$Gen$Pages$pages.home_.init(_Utils_Tuple0);
		case 'Impressum':
			return $author$project$Gen$Pages$pages.impressum.init(_Utils_Tuple0);
		case 'Method':
			return $author$project$Gen$Pages$pages.method.init(_Utils_Tuple0);
		default:
...
var $author$project$Gen$Pages$subscriptions = function (model_) {
	switch (model_.$) {
		...
		case 'Faq':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.faq.subscriptions, params, model);
		case 'Home_':
			var params = model_.a;
			var model = model_.b;
		...
		case 'Impressum':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.impressum.subscriptions, params, model);
		case 'Method':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.method.subscriptions, params, model);
		default:
			var params = model_.a;
			...
			switch (_v0.a.$) {
				...
				case 'Faq':
					if (_v0.b.$ === 'Faq') {
						...
						var params = _v3.a;
						var model = _v3.b;
						return A3($author$project$Gen$Pages$pages.faq.update, params, msg, model);
					} else {
						break _v0$6;
					}
				case 'Home_':
				...
				case 'Impressum':
					if (_v0.b.$ === 'Impressum') {
						...
						var params = _v5.a;
						var model = _v5.b;
						return A3($author$project$Gen$Pages$pages.impressum.update, params, msg, model);
					} else {
						break _v0$6;
					}
				default:
					if (_v0.b.$ === 'Method') {
						...
						var params = _v6.a;
						var model = _v6.b;
						return A3($author$project$Gen$Pages$pages.method.update, params, msg, model);
					} else {
						break _v0$6;
					}
			}
...
var $author$project$Gen$Pages$view = function (model_) {
	switch (model_.$) {
		...
		case 'Faq':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.faq.view, params, model);
		case 'Home_':
			var params = model_.a;
			var model = model_.b;
		...
		case 'Impressum':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.impressum.view, params, model);
		case 'Method':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.method.view, params, model);
		default:
			var params = model_.a;
